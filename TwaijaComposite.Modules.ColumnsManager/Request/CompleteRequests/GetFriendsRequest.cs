...
namespace TwaijaComposite.Modules.ColumnsManager.Request
{
   public class GetFriendsRequest
    : NavigationEnabledLoopBasedRequest_Twitter<AggregateMessage<TwitterProfile_SmallViewmodel>, IList<ITwitterProfile_Small>>
       {
       IRetrieveFollowers_Or_Friends_Method method;
           ...
           public GetFriendsRequest(IRetrieveFollowers_Or_Friends_Method method)
               : base(method)
           {
               this.method = method;
               method.Relationship = TwitterRelationship.Friends;
           }
